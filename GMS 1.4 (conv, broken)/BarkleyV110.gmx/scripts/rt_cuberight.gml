...
for (i = 0; i < 0.5; i += 0.05*timefactor)
    ...
    draw_vertex_texture(x2,y2,texw0,0);
    draw_vertex_texture(x1,h-y1,0,texh0);
    
    draw_vertex_texture(x2,y2,texw0,0);
    draw_vertex_texture(x1,h-y1,0,texh0);
    draw_vertex_texture(x2,h-y2,texw0,texh0);
    ...
    draw_vertex_texture(0,y3,0,0);
    draw_vertex_texture(x1,y1,texw1,0);
    draw_vertex_texture(0,h-y3,0,texh1);
    
    draw_vertex_texture(x1,y1,texw1,0);
    draw_vertex_texture(0,h-y3,0,texh1);
    draw_vertex_texture(x1,h-y1,texw1,texh1);
