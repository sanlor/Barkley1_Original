...
for (i = 1; i > 0; i -= 0.05*timefactor)
    ...
    draw_vertex_texture(-50*(1 - i),h/2 - h/2*i,0,0);
    draw_vertex_texture(50*(1 - i),h/2 + h/2*i,0,tex_h);
    draw_vertex_texture(w - 50*(1 - i),h/2 + h/2*i,tex_w,tex_h);
    
    draw_vertex_texture(-50*(1 - i),h/2 - h/2*i,0,0);
    draw_vertex_texture(w + 50*(1 - i),h/2 - h/2*i,tex_w,0);
    draw_vertex_texture(w - 50*(1 - i),h/2 + h/2*i,tex_w,tex_h);
